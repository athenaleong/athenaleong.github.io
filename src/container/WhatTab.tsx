...
const WhatTab: React.FC<any> = ({isMobile = false}: {
    ...
    <p className="mb-6 leading-loose">
        I love skipping down the streets; when I'm happy, I dance with abandon. I find our universe deeply fascinating - how cool is it that billions of years of happenings have led to life as we know it. I bathe in this wonder by learning broadly and deeply. I learn by making, and I hope to share my wonder through the projects I work on!
    </p>
    <p className="mb-6 leading-loose">
    ...
    <p className="mb-6 leading-loose">
        I care deeply about the journey. I am most grateful for my friends that traverse this journey with me. Their authentic presence and zest for life inspire me every day. They are like anglerfish! They show me everlasting exuberance whenever life gets unimaginably dark. I want to this journey to be true to myself and my values, with an abundance of joy, wide-eyed curiosity, and thoughtfulness!
    </p>
    <p className="mb-6 leading-loose">
    </p>
    </div>
